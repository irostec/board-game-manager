...
public class MechanicCollectionFilter
    implements CollectionFilter<Long, String, Mechanic, BoundaryException>
{
    ...
    @Override
    public Stream<Mechanic> findBySharedKeyAndUniqueKeysIn(
        Long sharedKey,
        Collection<String> uniqueKeys
    ) throws BoundaryException {

        return mechanicRepository.findByDataSourceIdAndExternalIdIn(sharedKey, uniqueKeys);
