...
public class BoardGameReferenceCollectionFilter
    implements CollectionFilter<DataSource, String, BoardGameReference>
{
    ...
    @Override
    public Stream<BoardGameReference> findByParentAndUniqueKeysIn(
        DataSource parent,
        Collection<String> uniqueKeys
    ) throws BoundaryException {

        return boardGameReferenceRepository.findByDataSourceAndExternalIdIn(parent, uniqueKeys);
