...
import com.irostec.boardgamemanager.application.fetchboardgamefrombgg.output.Image;
import com.irostec.boardgamemanager.application.fetchboardgamefrombgg.output.Name;
import com.irostec.boardgamemanager.application.fetchboardgamefrombgg.output.Reference;
import com.irostec.boardgamemanager.application.fetchboardgamefrombgg.output.Video;
...
final class OutputMapper {
    ...
    static Map<String, Object> toMap(BoardGameFromBGGWithPartitionedLinks boardGame) {
        ...
        return ImmutableMap.<String, Object>builder()
                ...
                .put("minPlayers", boardGame.minPlayers().value())
                .put("maxPlayers", boardGame.maxPlayers().value())
                .put("minPlaytimeInMinutes", boardGame.minPlaytimeInMinutes().value())
                .put("maxPlaytimeInMinutes", boardGame.maxPlaytimeInMinutes().value())
